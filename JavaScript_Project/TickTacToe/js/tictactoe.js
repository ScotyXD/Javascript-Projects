     ...
     if (!selectedSquares.some(element => element.includes(squareNumber))) {
          ...
          function checkWinConditions() {
                    ...
                    if       (arrayIncludes('0X', '1X', '2X')) { drawWinLine(50, 100, 558, 100); }
                     ...
                     else if (arrayIncludes('6X', '7X', '8X')) { drawWinLine(100, 50, 100, 558); }
                     ...
                     else if (arrayIncludes('3O', '4O', '5O')) { drawWinLine(50, 508, 558, 508);}
                     else if (arrayIncludes('6O', '7O', '8O')) { drawWinLine(100, 50, 100, 558);}
                     else if (arrayIncludes('0O', '3O', '6O')) { drawWinLine(304, 50, 304, 558);}
                     else if (arrayIncludes('1O', '4O', '7O')) { drawWinLine(508, 50, 508, 558);}
                     else if (arrayIncludes('2O', '5O', '8O')) { drawWinLine(100, 508, 510, 90);}
